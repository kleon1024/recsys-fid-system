...
| Search/Ads/Commerce/Live/Local/Posting | Surface actions and catalog types exist; Commerce now closes cart→order→payment→refund, reservation and independent inventory LR mechanics | Commerce implementation in validation; other surfaces remain skeletons | C-LR-003 and full gate remain pending; Search, Ads, Local, Posting and Live still need closed workflows |
