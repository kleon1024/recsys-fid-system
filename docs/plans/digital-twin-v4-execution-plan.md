...
| Search/Ads/Commerce/Live/Local/Posting | Commerce closes cart→refund; Search closes query→success/reformulation→post-search Feed and has an independent semantic-route LR | Commerce and Search implementations in validation; Ads, Local, Posting and Live remain skeletons | C-LR-003 and S-LR-001 RTX evidence remain pending; four other workflows are still open |
